    ...
    return `
      <article class="attraction-card" id="attr-${esc(a.id)}" data-city="${esc(a.city)}" data-type="${esc(a.type)}" data-search="${esc(searchable)}">
        ...
        <details class="attr-details">
          <summary>Storia, aneddoti e consigli pratici</summary>
          <div class="attr-detail-body">
            <div class="story-block"><h4><i class="ti ti-books"></i>Storia e contesto</h4><p>${esc(a.history)}</p></div>
            <div class="story-block"><h4><i class="ti ti-bulb"></i>Aneddoto</h4><p>${esc(a.anecdote)}</p></div>
            <div class="story-block"><h4><i class="ti ti-compass"></i>Come visitarla</h4><p>${esc(a.tip)}</p></div>
            <div class="story-block"><h4><i class="ti ti-link"></i>Collegamenti con l'itinerario</h4><div class="backlinks">${backlinks(a)}</div></div>
          </div>
        </details>
      </article>`;
  }
